...
### Year 3:
CSCI, IERG courses are from CUHK
- CSCI2720 (Building Web Applications)
- CSCI2730 (Blockchain Technology)
- CSCI4160 (Distributed Systems)
- CSCI4180 (Cloud Computing)
- IERG4230 (Introduction to Blockchain Technologies and Applications)
- SC3079 (Professional Internship)

### Year 4:
- SC2079 (Multi Disciplinary Project)
- SC3010 (Computer Security)
- SC3020 (Database Systems Principles)
- SC4002 (Natural Language Processing)
- SC4062 (Advanced Topics - Generative AI)
...
- **Synapxe** (Semester 2 AY24/25)
  - Developed and implemented proof-of-concept PostgreSQL and MongoDB integration to improve completeness and comprehensiveness for complex queries for LightRAG to assess the feasibility, performance, and scalability for large-scale production.
  - Collaborated with a team of data scientists and engineers to enhance current Generative AI applications, by experimenting with different styles of Prompt Engineering, reviewing, debugging code, and performing tests.
  - Tech: Azure AI Services, Azure AI Document Intelligence, Azure DevOps, Azure CosmosDB, PostgreSQL, LangChain, LangGraph, Pydantic
- **iStaging** (Summer 2024)
  - Conducted comprehensive research and contributed to the development of a Generative AI Chatbot utilizing Amazon Web Services (AWS) Transcribe, Bedrock, Polly, and Translate.
  - Enhanced Retrieval Augmented Generation (RAG) techniques to optimize search capabilities using AWS Bedrock Agents with Claude 3 Haiku, a large language model by Anthropic.
  - Tech: AWS, Python, JavaScript, REST API, Prompt Engineering, Jira
...
[Pydantic]: https://img.shields.io/badge/Pydantic-333333?style=for-the-badge&logo=pydantic&logoColor=white
